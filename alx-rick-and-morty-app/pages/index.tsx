...
const Home: React.FC = () => {
  ...
  return (
    <div
      className={`${geistSans.className} ${geistMono.className} min-h-screen flex flex-col bg-gradient-to-b from-[#A3D5E0] to-[#F4F4F4] text-gray-800 p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]`}
    >
      {/* Header */}
      ...
      {/* Main Content */}
      <main className="flex-grow p-6 flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <Image
